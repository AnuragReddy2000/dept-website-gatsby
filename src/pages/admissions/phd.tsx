        ...
        return(
            <div style={{display: 'flex', flexDirection: 'column'}}>
                ...
                <div className='phdAdmissionsMiddle'>
                    ...
                    <p style={{marginBottom: '1.5px'}}>Selection list: <a href='https://math.iith.ac.in/pdfs/SelectedCandidates-PhD-Summer2020-v2.pdf'>Click Here</a></p> 
                    <p style={{marginBottom: '1.5px'}}> Waiting list: <a href='https://math.iith.ac.in/pdfs/WaitlistCandidates-PhD-Summer2020-v2.pdf'>Click Here</a></p>
                    <p style={{color: 'darkblue', fontSize: 'x-large', marginBottom: '3px'}}>Ph.D. interviews Schedule July, 2020:</p>
                    <p style={{marginBottom: '1.5px'}}>Algebra: <a href='https://math.iith.ac.in/pdfs/Interview%20algebra-PhDJuly%202020.pdf'>Schedule</a> - <a href='https://math.iith.ac.in/pdfs/Instructions.pdf'>Instructions</a></p>
                    <p style={{marginBottom: '1.5px'}}>Analysis: <a href='https://math.iith.ac.in/pdfs/Analysis-PhD%20July2020%20-%20TentaiveSchedule.pdf'>Schedule and Instruction</a> </p>
                    <p style={{marginBottom: '1.5px'}}>Differential Equations: <a href='https://math.iith.ac.in/pdfs/PhD_interviewDiff_Eqn.pdf'>Schedule</a> - <a href='https://math.iith.ac.in/pdfs/Instructions.pdf'>Instructions</a></p>
                    <p style={{marginBottom: '1.5px'}}>Statistics: <a href='https://math.iith.ac.in/pdfs/Interview%20Schedule_Statistics.pdf'>Schedule and Instruction</a> </p>
                </div>
                ...
                link='https://math.iith.ac.in/pdfs/ShortlistedCandidates-PhD-Summer2020.pdf' linkText='List of Shortlisted Candidates'
                />
